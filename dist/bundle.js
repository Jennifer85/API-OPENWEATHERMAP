...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  /**
	   * Get a text descripcion of the component that can be used to identify it
	   * in error messages.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *     propTypes: {
	 *       // An optional string prop named "descripcion".
	 *       descripcion: Props.string,
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxThunk = __webpack_require__(/*! redux-thunk */ 181);
	
	var _reduxThunk2 = _interopRequireDefault(_reduxThunk);
	
	var _index = __webpack_require__(/*! ../reducers/index */ 182);
	
	var _index2 = _interopRequireDefault(_index);
	
	var _SPACLIMA = __webpack_require__(/*! ./SPACLIMA/SPACLIMA */ 184);
	
	var _SPACLIMA2 = _interopRequireDefault(_SPACLIMA);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { store: store },
	                    _react2.default.createElement(_SPACLIMA2.default, null)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hoistNonReactStatics = __webpack_require__(/*! hoist-non-react-statics */ 179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(/*! ./combineReducers */ 171);
	
	var _combineReducers2 = _interopRequireDefault(_combineReducers);
	
	var _bindActionCreators = __webpack_require__(/*! ./bindActionCreators */ 173);
	
	var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);
	
	var _applyMiddleware = __webpack_require__(/*! ./applyMiddleware */ 174);
	
	var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);
	
	var _compose = __webpack_require__(/*! ./compose */ 175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(/*! ./_isHostObject */ 177),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionTypes = __webpack_require__(/*! ../constants/ActionTypes */ 183);
...
/***/ function(module, exports) {
	 ...
	 * Created by  on 29.03.16.
	 */
	var ADD_TOWN = exports.ADD_TOWN = "ADD_TOWN";
	var REMOVE_TOWN = exports.REMOVE_TOWN = "REMOVE_TOWN";
	
	var RECEIVE_TOWN_DATA = exports.RECEIVE_TOWN_DATA = "RECEIVE_TOWN_DATA";

/***/ },
/* 184 */
/*!*************************************************!*\
  !*** ./src/containers/SPACLIMA/SPACLIMA.js ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _weatherActions = __webpack_require__(/*! ../../actions/weatherActions */ 185);
	
	var Actions = _interopRequireWildcard(_weatherActions);
	
	__webpack_require__(/*! ./SPACLIMA.css */ 204);
	
	var _Header = __webpack_require__(/*! ../../components/Header/Header */ 208);
	
	var _Header2 = _interopRequireDefault(_Header);
	
	var _CityList = __webpack_require__(/*! ../../components/CityList/CityList */ 211);
	
	var _CityList2 = _interopRequireDefault(_CityList);
	
	var _CityAdd = __webpack_require__(/*! ../../components/CityAdd/CityAdd */ 217);
	
	var _CityAdd2 = _interopRequireDefault(_CityAdd);
	...
	var SPACLIMA = function (_React$Component) {
	    _inherits(SPACLIMA, _React$Component);
	
	    function SPACLIMA(props) {
	        _classCallCheck(this, SPACLIMA);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SPACLIMA).call(this, props));
	    ...
	    _createClass(SPACLIMA, [{
	        key: 'render',
	        value: function render() {
	            var _props = this.props;
	            var towns = _props.towns;
	            var actions = _props.actions;
	            var myTown = _props.myTown;
	
	            return _react2.default.createElement(
	                'div',
	                { className: 'content' },
	                _react2.default.createElement(_Header2.default, { myTown: myTown }),
	                _react2.default.createElement(_CityAdd2.default, { addTown: actions.addTown }),
	                _react2.default.createElement(_CityList2.default, { data: towns, requestDataForTown: actions.requestDataForTownByName })
	            );
	        }
	    }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SPACLIMA);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.removeTown = removeTown;
	exports.requestDataForTownByName = requestDataForTownByName;
	exports.requestDataForTownByCoords = requestDataForTownByCoords;
	exports.receiveDataMyTown = receiveDataMyTown;
	...
	var _config = __webpack_require__(/*! ../config */ 203);
	...
	function requestDataForTownByName(name, id) {
	    return function (dispatch) {
	        _axios2.default.get(_config2.default.URL, {
	            params: {
	                APPID: _config2.default.KEY,
	                q: name,
	                lang: 'ru',
	                units: 'metric'
	            }
	...
	function requestDataForTownByCoords(x, y) {
	    return function (dispatch) {
	        _axios2.default.get(_config2.default.URL, {
	            params: {
	                APPID: _config2.default.KEY,
	...
	function receiveDataMyTown(response, idTown) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InterceptorManager = __webpack_require__(/*! ./core/InterceptorManager */ 198);
	...
	var bind = __webpack_require__(/*! ./helpers/bind */ 201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(/*! ./../helpers/btoa */ 196);
...
/***/ function(module, exports) {
	...
	var OPEN_WEATHER_MAP = {
	    URL: "http://api.openweathermap.org/data/2.5/weather?",
	    KEY: "8a9f4e6ada84194290d93785f9a93be8"
	};
	
	exports.default = OPEN_WEATHER_MAP;

/***/ },
/* 204 */
/*!**************************************************!*\
  !*** ./src/containers/SPACLIMA/SPACLIMA.css ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./SPACLIMA.css */ 205);
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./SPACLIMA.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./SPACLIMA.css");
...
/* 205 */
/*!*****************************************************************!*\
  !*** ./~/css-loader!./src/containers/SPACLIMA/SPACLIMA.css ***!
  \*****************************************************************/
/***/ function(module, exports, __webpack_require__) {

	exports = module.exports = __webpack_require__(/*! ./../../../~/css-loader/lib/css-base.js */ 206)();
	// imports
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./Header.css */ 209);
	...
	var Header = function (_React$Component) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            ...
	            if (!myTown) {
	                myTown = _react2.default.createElement(
	                    "div",
	                    { className: "header" },
	                    _react2.default.createElement(
	                        "p",
	                ...
	                myTown = _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "label",
	                        { className: "header-Temperatura" },
	                        " Temperatura ",
	                        myTown.main.temp,
	                        " C.  descripcion : ",
	                        myTown.weather[0].descripcion
	                    )
	                );
	            }
	            return myTown;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./Header.css */ 210);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 207)(content, {});
	if(content.locals) module.exports = content.locals;
...
/* 210 */
/*!*********************************************************!*\
  !*** ./~/css-loader!./src/components/Header/Header.css ***!
  \*********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".header {\n    font-family: Roboto;\n    font-weight: bold;\n    background-color: #fff;\n    padding: 25px 0px 25px 100px;\n    box-shadow: 0 0 20px rgba(0,0,0,0.3); /* Параметры тени */\n}\n\n.header-title {\n    font-size: 30px;\n}\n\n.header-app {\n    font-size: 48px;\n    margin: 0px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./CityList.css */ 212);
	
	var _react = __webpack_require__(/*! react */ 1);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _CityRow = __webpack_require__(/*! ../CityRow/CityRow */ 214);
	
	var _CityRow2 = _interopRequireDefault(_CityRow);
	    ...
	    _createClass(CityList, [{
	        ...
	        value: function render() {
	            ...
	            var listTowns = this.props.data == undefined ? '' : this.props.data.map(function (town, i) {
	                return _react2.default.createElement(_CityRow2.default, { key: i, town: town, id: i, request: self.props.requestDataForTown });
	            });
	            return _react2.default.createElement(
	                "div",
	                { className: "city-list" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./CityList.css */ 213);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 207)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./CityList.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./CityList.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 213 */
/*!*************************************************************!*\
  !*** ./~/css-loader!./src/components/CityList/CityList.css ***!
  \*************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 214 */
/*!*******************************************!*\
  !*** ./src/components/CityRow/CityRow.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./CityRow.css */ 215);
	...
	var CityRow = function (_React$Component) {
	    _inherits(CityRow, _React$Component);
	
	    function CityRow(props) {
	        _classCallCheck(this, CityRow);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CityRow).call(this, props));
	
	        var self = _this;
	        _this.props.request(_this.props.town.name, _this.props.id);
	        return _this;
	    }
	        ...
	        value: function render() {
	            ...
	            if (t.data) {
	                data = _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "city-row-data" },
	                        _react2.default.createElement(
	                            "p",
	                            { className: "city-row-temp" },
	                            "Temperatura: ",
	                            t.data.main.temp,
	                            " C."
	                        ),
	                        _react2.default.createElement(
	                            "p",
	                            { className: "city-row-desc" },
	                            "descripcion: ",
	                            t.data.weather[0].descripcion
	                        )
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: "city-row-icon" },
	                        _react2.default.createElement("img", { src: "http://openweathermap.org/img/w/" + t.data.weather[0].icon + ".png" })
	                    )
	                );
	            } else {
	                data = 'Loading...';
...
/* 215 */
/*!********************************************!*\
  !*** ./src/components/CityRow/CityRow.css ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./CityRow.css */ 216);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 207)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./CityRow.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./CityRow.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 216 */
/*!***********************************************************!*\
  !*** ./~/css-loader!./src/components/CityRow/CityRow.css ***!
  \***********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".city-row {\n    background-color: #fff;\n    padding: 10px;\n    border-bottom: 2px solid #f1f1f1;\n    font-family: Roboto;\n}\n.city-row-data{\n    width: 70%;\n    vertical-align: middle;\n    display: inline-block;\n}\n.city-row-icon {\n    width: 30%;\n    text-align: right;\n    vertical-align: middle;\n    display: inline-block;\n}\n\n.city-row-town {\n    margin: 0px;\n    font-size: 24px;\n}\n\n.city-row-temp {\n    margin: 0px;\n    font-size: 16px;\n}\n\n.city-row-desc {\n    margin: 0px;\n    font-size: 16px;\n}", ""]);
...
/* 217 */
/*!*******************************************!*\
  !*** ./src/components/CityAdd/CityAdd.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./CityAdd.css */ 218);
	...
	var CityAdd = function (_React$Component) {
	    _inherits(CityAdd, _React$Component);
	
	    function CityAdd(props) {
	        _classCallCheck(this, CityAdd);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CityAdd).call(this, props));
	    ...
	    _createClass(CityAdd, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "city-add" },
	                _react2.default.createElement("input", { className: "city-add-input", type: "text", onKeyPress: this.handleEnter })
	            );
	        }
	    }]);
	...
	exports.default = CityAdd;

/***/ },
/* 218 */
/*!********************************************!*\
  !*** ./src/components/CityAdd/CityAdd.css ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./CityAdd.css */ 219);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 207)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./CityAdd.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./CityAdd.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 219 */
/*!***********************************************************!*\
  !*** ./~/css-loader!./src/components/CityAdd/CityAdd.css ***!
  \***********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".city-add {\n    margin: 20px 30%;\n    box-shadow: 0 0 20px rgba(0,0,0,0.3); /* Параметры тени */\n}\n\n.city-add-input {\n    width: 100%;\n    font-size: 30px;\n    font-weight: bold;\n    font-family: Roboto;\n    border: 0px ;\n    border-bottom: 2px solid #40a070;\n}\n.city-add-input:focus {\n    outline: none;\n}", ""]);
